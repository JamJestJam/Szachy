...
namespace TestRuchowBierek
{
    ...
    public class HetmanTest
    {
        ...
        [DataRow(7, 5)]
        [DataRow(7, 6)]
        public void TestRuchowHetmanaNiemozliwychDoWykonania(int x, int y)
        {
            //tworzenie danych
            List<Bierka> listaBierek = new List<Bierka>();
            Plansza plansza = new Plansza(null, null, listaBierek);
        ...
        [DataRow(7, 4)]
        [DataRow(7, 7)]
        public void TestRuchowHetmanaOgraniczonegoInnymiBierkamiTegoSamegoKoloru(int x, int y)
        {
            //tworzenie danych
            List<Bierka> listaBierek = new List<Bierka>();
            Plansza plansza = new Plansza(null, null, listaBierek);
            ...
            listaBierek.Add(new Hetman(new Punkt(6, 4), Strona.Biała, plansza));
            listaBierek.Add(new Hetman(new Punkt(2, 4), Strona.Biała, plansza));
            listaBierek.Add(new Hetman(new Punkt(4, 6), Strona.Biała, plansza));
            listaBierek.Add(new Hetman(new Punkt(4, 2), Strona.Biała, plansza));

            listaBierek.Add(new Hetman(new Punkt(6, 6), Strona.Biała, plansza));
            listaBierek.Add(new Hetman(new Punkt(2, 2), Strona.Biała, plansza));
            listaBierek.Add(new Hetman(new Punkt(6, 2), Strona.Biała, plansza));
            listaBierek.Add(new Hetman(new Punkt(2, 6), Strona.Biała, plansza));
        ...
        [DataRow(7, 4)]
        [DataRow(7, 7)]
        public void TestRuchowHetmanaZasloniecieKrola(int x, int y)
        {
            //tworzenie danych
            List<Bierka> listaBierek = new List<Bierka>();
            Plansza plansza = new Plansza(null, null, listaBierek);
